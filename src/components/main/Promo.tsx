...
export default function Promo() {
  ...
  return (
    <div className="flex md:flex-row flex-col justify-center items-center gap-8 py-10 px-10">
      <div className="w-2/3">
        <Image
          src="https://i.pinimg.com/564x/3c/60/94/3c60949bb2d055241dc915cc80742b84.jpg"
          width={400}
          height={400}
          alt="image"
      ...
      <div className="flex flex-col justify-center items-center md:items-stretch">
        ...
        <Carousel className="md:w-full w-2/3" setApi={setApi}>
                ...
                <div className="p-1">
                  <Card>
                    <CardContent className="flex flex-col aspect-square items-center justify-around p-6">
                      <Image src={item.image} alt="image" width={300} height={300} />
