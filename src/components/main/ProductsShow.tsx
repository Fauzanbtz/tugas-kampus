...
export default function ProductsShow() {
  return (
    <div className="flex flex-col gap-6 justify-center items-center py-10 ">
      <h1 className="md:font-bold font-semibold text-xl md:text-4xl text-primary text-center md:w-2/3">
